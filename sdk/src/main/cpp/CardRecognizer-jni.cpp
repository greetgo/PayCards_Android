...
Java_cards_pay_paycardsrecognizer_sdk_ndk_RecognitionCoreNdk_nativeSetDataPath(JNIEnv *env,
                                                                               jobject instance,
                                                                               jstring path_) {
    std::string stdPath;
    ...
    g_core->SetPathCurrencyLocalizationXModel(
            stdPath + "CurrencyLocalization/CurrencyLocalizationX.caffemodel");
    g_core->SetPathCurrencyLocalizationXStruct(
            stdPath + "CurrencyLocalization/CurrencyLocalizationX.prototxt");
    g_core->SetPathCurrencyYLocalizationViola(
            stdPath + "NameLocalization/cascade_name.xml");

    g_core->SetPathCurrencySpaceCharModel(
            stdPath + "NameRecognition/NameSpaceCharRecognition.caffemodel");
    g_core->SetPathCurrencySpaceCharStruct(
            stdPath + "NameRecognition/NameSpaceCharRecognition.prototxt");
    g_core->SetPathCurrencyListTxt(stdPath + "NameRecognition/names.txt");
...
JNIEXPORT void JNICALL
Java_cards_pay_paycardsrecognizer_sdk_ndk_RecognitionCoreNdk_nativeDestroy(JNIEnv *env,
                                                                           jclass type) {
    g_core = nullptr;
}
...
JNIEXPORT void JNICALL
Java_cards_pay_paycardsrecognizer_sdk_ndk_RecognitionCoreNdk_nativeSetIdle(JNIEnv *env,
                                                                           jobject instance,
                                                                           jboolean idle) {
    g_core->SetIdle(idle);
