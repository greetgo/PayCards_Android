...
bool CServiceContainer::Initialize()
{
    ...
    shared_ptr<CCurrencyRecognizer> currencyRecognizerObject = make_shared<CCurrencyRecognizer>(sharedThis);
    mapSingleInstanceTypeToGenerator<ICurrencyRecognizer>(currencyRecognizerObject);
